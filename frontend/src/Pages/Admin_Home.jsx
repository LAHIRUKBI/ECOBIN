      ...
      <aside className="w-72 bg-green-700 text-white shadow-lg p-6 flex flex-col">
              ...
              <nav className="mt-6">
                <ul className="space-y-4">
                  <li className="flex items-center p-4 bg-green-600 rounded-md transition" onClick={() => navigate("/adminhome")}> <FaUserPlus className="text-white text-lg mr-3" /> <span className="font-medium">Admin Home</span></li>
